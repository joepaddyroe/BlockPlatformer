namespace Quantum {
  ...
  public void Start()
    ...
    public void StartWithFrame(int frameNumber = 0, byte[] frameData = null) {
      ...
      var mapdata = FindObjectsOfType<QuantumMapData>()[0];
      if (mapdata == null) {
      ...
      var dynamicDB = new DynamicAssetDB(new QuantumUnityNativeAllocator(), legacyMode: DynamicAssetDB.IsLegacyModeEnabled);
      ...
      var arguments = new SessionRunner.Arguments {
        ...
        GameFlags             = (IsTaskProfilerEnabled ? QuantumGameFlags.EnableTaskProfiler : 0) |
                                (DynamicAssetDB.IsLegacyModeEnabled ? QuantumGameFlags.EnableLegacyDynamicDBMode : 0),
