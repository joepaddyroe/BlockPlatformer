namespace Quantum.Editor {
  ...
  /// Readable and compareable frame dumps are sent by other clients and can be compared after a desync error.
  /// </summary>
    ...
    private static StaticFrameStateStorage Storage {
      get {
        if (!_stateStorage) {
          ...
          _stateStorage = FindObjectsOfType<StaticFrameStateStorage>()[0];
          if (!_stateStorage) {
